...
{
    public String messageReceiverID,messageReceiverName,messageReceiverImage,messageSenderID;

    private TextView userName,userLastSeen;
    private CircleImageView userImage;
    private ImageButton SendMessageButton,SendFilesButton,locationButton;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        MainActivity.getInstance().updateUserStatus("online");
        ...
        locationButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                //MapsActivity2.getInstance().getlocationofuser(messageReceiverID);
                    ...
                    public void onSuccess(@NonNull UploadTask.TaskSnapshot taskSnapshot)
                    {
                        ...
                        filepath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>()
                        {
                            ...
                            public void onSuccess(Uri uri)
                            {
                                ...
                                messageBodyDetails.put(messageRecieverRef + "/" + messagePushID,messageImageBody);
    ...
    private void sendusertomaps2()
    {
        Intent intent = new Intent(ChatActivity.this,MapsActivity2.class);
        intent.putExtra("messagerecieverID",messageReceiverID);
   ...
   /* @Override
    protected void onDestroy() {
        super.onDestroy();
        MainActivity.getInstance().updateUserStatus("offline");
